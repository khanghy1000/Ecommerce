...
namespace Ecommerce.Persistence.Migrations
{
    ...
    public partial class AddPaymentEntity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VnpayTransactionId = table.Column<long>(
                        type: "bigint",
                        maxLength: 100,
                        nullable: false
                    ),
                    ...
                    ResponseCode = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: true
                    ),
                    ResponseDescription = table.Column<string>(
                        type: "character varying(255)",
                        maxLength: 255,
                        nullable: true
                    ),
                    TransactionCode = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: true
                    ),
                    TransactionDescription = table.Column<string>(
                        type: "character varying(255)",
                        maxLength: 255,
                        nullable: true
                    ),
                    BankCode = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: true
                    ),
                    BankTransactionId = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "PK_PaymentSalesOrder",
                        x => new { x.PaymentsPaymentId, x.SalesOrderId }
                    );
                    table.ForeignKey(
        ...
        {
            migrationBuilder.DropTable(name: "PaymentSalesOrder");
